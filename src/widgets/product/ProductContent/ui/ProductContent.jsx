...
export const ProductContent = React.memo(({
    ...
    const handleAvatarPress = (clientId) => {
        if (navigation?.navigate && clientId) {
            navigation.navigate('UserPublicProfile', { userId: clientId });
        }
    };
            ...
            <View style={[
                ...
                <View style={styles.ratingContainer}>
                    ...
                    >
                        <FeedbackAvatars
                            feedbacks={safeFeedbacks}
                            isExpanded={isAvatarsExpanded}
                            onToggle={handleAvatarsToggle}
    ...
    const reviewsBlock = activeTab === 'reviews' && safeProduct.id && (
        <View
    ...
    return (
        <View style={styles.mainContainer}>
            <TouchableWithoutFeedback
                onPress={handleAvatarsToggle}
                disabled={!isAvatarsExpanded}
            >
                <View style={styles.mainContainer}>
                    {contentBlock}
                    {reviewsBlock}
