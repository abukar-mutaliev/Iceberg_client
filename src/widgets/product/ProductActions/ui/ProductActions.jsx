...
const useProductForEdit = (product) => {
    return useMemo(() => {
        ...
        return {
            ...
            itemsPerBox: product.itemsPerBox ?? product.boxInfo?.itemsPerBox ?? 1,
            boxPrice: product.boxPrice ?? product.boxInfo?.boxPrice ?? '',
            moderationStatus: product.moderationStatus || 'APPROVED',
            supplierProposedPrice: product.supplierProposedPrice ?? null,
            supplierProposedBoxPrice: product.supplierProposedBoxPrice ?? null,
